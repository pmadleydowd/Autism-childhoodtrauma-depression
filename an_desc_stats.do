...
* Date: 2022-03-16
* Description: Descriptive statistics of ALSPAC Autism and autism traits
********************************************************************************
* Contents
********************************************************************************
...
table1_mc,  ///
				...
				saving("$Datadir\Descriptives\Desc_total.xlsx", replace)
		


foreach var in  ASD bin_scdc bin_coherence bin_repbehaviour bin_sociability bin_afms bin_aPRS {
	table1_mc,  by(`var') ///
				vars( /// 
				male cat %5.1f \ ///
				child_ethnicity cat %5.1f \ ///		
				...
				nospace onecol missing total(before) test ///
				saving("$Datadir\Descriptives\Desc_`var'.xlsx", replace)
}					 
